...
class MainWin(Tk):
    def __init__(self):
        ...
        self.configure(bg='#cef4fd')
        self.canvas = Canvas(width=1366, height=768, bg='#cef4fd')
        self.canvas.pack()
        self.maxsize(1320, 768)
        self.minsize(1320,768)
        self.state('zoomed')
        self.title('ASBC LIBRARY')
        self.a = StringVar()
        self.b = StringVar()
        ...
        def check():
            try:
                ...
                if not z:
                    ...
                    #label and input box
                    self.label3 = Label(self, text='ALL SOULS BAPTIST CHURCH LIBRARY',fg='black',bg="#cef4fd" ,font=('Courier new', 30, 'bold'))
                    self.label3.place(x=350, y=22)
                    self.label4 = Label(self, text="ENTER STUDENT",bg="#cef4fd", font=('Courier new', 18, 'bold'))
                    ...
                    self.label5 = Label(self, text="ENTER THE BOOK ID",bg="#cef4fd", font=('Courier new', 18, 'bold'))
                    ...
                    self.label6 = Label(self, text="INFORMATION DETAILS",bg="#cef4fd",  font=('Courier new', 15, 'underline', 'bold'))
                    ...
                    self.brt = Button(self, text="LOGOUT", width=15,bg="#74dbf2", font=('Courier new', 10, 'bold'), command=log).place(x=1150, y=105)
            except Error:
                messagebox.showerror("Error", "Something Went Wrong")
        check()
