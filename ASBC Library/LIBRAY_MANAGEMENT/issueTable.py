...
#label and input box
        Label(self, text='Book Issuing',bg = '#cef4fd', font=('Courier new', 24)).place(x=135, y=40)
        Label(self, text='Book ID:',bg = '#cef4fd', font=('Courier new', 15), fg='black').place(x=55, y=100)
        Entry(self, textvariable=c, width=40).place(x=160, y=106)
        Label(self, text='Student ID:',bg = '#cef4fd', font=('Courier new', 15), fg='black').place(x=20, y=150)
