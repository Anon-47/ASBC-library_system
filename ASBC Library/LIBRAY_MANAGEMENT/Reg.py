...
class reg(Tk):
    def __init__(self):
        ...
        self.title('Add User')
        self.canvas = Canvas(width=500, height=417, bg='#cef4fd')
        self.canvas.pack()
...
#label and input
        Label(self, text='User Details', bg='#cef4fd', fg='black', font=('Courier new', 25, 'bold')).place(x=130, y=22)
        Label(self, text='Username:', bg='#cef4fd', font=('Courier new', 10, 'bold')).place(x=70, y=82)
        Entry(self, textvariable=u, width=30).place(x=200, y=84)
        Label(self, text='Name:', bg='#cef4fd', font=('Courier new', 10, 'bold')).place(x=70, y=130)
        Entry(self, textvariable=n, width=30).place(x=200, y=132)
        Label(self, text='Password:', bg='#cef4fd', font=('Courier new', 10, 'bold')).place(x=70, y=180)
