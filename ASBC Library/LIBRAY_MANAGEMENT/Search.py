...
class Search(Tk):
    def __init__(self):
        ...
        self.canvas = Canvas(width=800, height=500, bg='#cef4fd')
        self.canvas.pack()
        self.iconbitmap(r'libico.ico')
        l1=Label(self,text="Search Library",bg='#cef4fd', font=("Courier new",20,'bold')).place(x=290,y=20)
        l = Label(self, text="Search By",bg='#cef4fd', font=("Courier new", 15, 'bold')).place(x=60, y=96)
        def insert(data):
        ...
        def ge():
            if (len(g.get())) == 0:
                ...
                try:
                    ...
                    messagebox.showerror("Error","Something Went wrong")
        b=Button(self,text="Find",width=15,bg='#cef4fd',font=("Courier new",10,'bold'),command=ge).place(x=460,y=148)
        ...
        la = Label(self, text="Enter",bg='#cef4fd', font=("Courier new", 15, 'bold')).place(x=100, y=150)
