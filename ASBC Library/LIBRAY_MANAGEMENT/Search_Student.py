...
class Search(Tk):
    def __init__(self):
        ...
        l1=Label(self,text="Search Student",bg='#cef4fd', font=("Courier new",20,'bold')).place(x=290,y=40)
        l = Label(self, text="Search By",bg='#cef4fd', font=("Courier new", 15, 'bold')).place(x=180, y=100)
        ...
        self.la = Label(self, text="Enter",bg = '#cef4fd', font=("Courier new", 15, 'bold')).place(x=180, y=140)
